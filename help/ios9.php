      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li>
		    ...
		    <li>
            <div class="m-t-sm"> <a href="../user/login.php" class="btn btn-warning btn-sm m-l">会员登录</a><a href="../user/register.php" class="btn btn-sm btn-success m-l"><strong>用户注册</strong></a>  </div>
          </li>
		   <li>
		      <br>
		   </li>
...
<footer id="footer">
      ...
      <div class="container wrapper">
        <div class="m-t-xl m-b">
          马上点击下方开始您的稳定高速上网体验.
          <a href="../user/login.php" class="btn btn-lg btn-dark b-white bg-empty m-sm">登陆使用</a>
          <a href="../user/register.php" class="btn btn-lg btn-warning b-white bg-empty m-sm">注册账户</a>
        </div>
      </div>
		...
		<div class="container text-center m-t-lg">
			<div class="row m-t-xl m-b-xl">
				...
				<div class="col-sm-4" data-ride="animated" data-animation="fadeInUp" data-delay="600">
					...
					<p class="text-sm"><a href="../user/login.php">在线工单技术支持,最快回复</a><br>在使用本站服务过程中有任何问题欢迎提交工单.</p>
				</div>
